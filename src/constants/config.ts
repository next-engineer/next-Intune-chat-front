...
export const config: Config = {
  // API 설정
  USER_API_URL: getEnvVar('VITE_USER_API_URL', 'http://api.intune.member.nextcloudlab.com'),
  CHAT_API_URL: getEnvVar('VITE_CHAT_API_URL', 'http://api.intune.chat.nextcloudlab.com'),
