              ...
              <div className="mb-4">
                ...
                {userMenuItems.map((item, index) => (
                  <button
                    key={index}
                    onClick={() => item.action ? item.action() : handleNavigation(item.path)}
                    className="w-full flex items-center space-x-3 px-3 py-3 text-left text-gray-700 hover:bg-gray-100 rounded-lg transition-colors group"
                  >
                    <div className="text-gray-400 group-hover:text-primary transition-colors">
                      {item.icon}
                    </div>
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">계정에 로그인</p>
                  </div>
                </button>
                <button
